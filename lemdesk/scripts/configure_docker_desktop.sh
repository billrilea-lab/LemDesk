...
echo ""
echo "=== Storage (Mac Mini — keep internal SSD free) ==="
echo "  Docker engine should use: /Volumes/GC-MM2/Docker (Docker Desktop → Settings → Resources)"
echo "  DMR models (~15GB):       ./lemdesk/scripts/relocate_storage.sh --apply"
echo "  NAS shared AI corpus:     /Volumes/docker/AI"
